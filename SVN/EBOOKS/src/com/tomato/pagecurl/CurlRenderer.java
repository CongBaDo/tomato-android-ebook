...
//	CurlActivity ka = new CurlActivity();/*전체를 보여주기위해*/
...
//		ArrayList ka2 = new ArrayList();/*전체를 보여주기위해*/
//		ka2= (ArrayList) ka.actsizegogo();/*전체를 보여주기위해*/
//		Object chi2 =ka2.get(0);/*전체를 보여주기위해*/
//		Object chi=ka2.get(1);/*전체를 보여주기위해*/
//		height =Integer.parseInt(chi.toString());/*전체를 보여주기위해*/
//		height-=50; /*전체를 보여주기위해*/
//		width= Integer.parseInt(chi2.toString());/*전체를 보여주기위해*/
//		Log.e("negabaro width:",width+"");/*전체를 보여주기위해*/
//		Log.e("negabaro height:",height+"");/*전체를 보여주기위해*/
		gl.glViewport(0, 0, width, height);
		//gl.glViewport(0, 0, 3, height);
	...
	public synchronized void setMargins(float left, float top, float right,
			float bottom) {
		/*김세화의 임이대로 마진이라 생겨먹은것은 전멸시켜보자*/
//		left=0; top=0; right=0; bottom=0;/*전체를 보여주기위해*/
		mMargins.left = left;
		mMargins.top = top;
