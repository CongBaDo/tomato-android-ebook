...
public class ReadVerticalSetup extends Activity{
	...
	private OnClickListener click_btn=new OnClickListener() {
		...
		public void onClick(View v) {
			...
			new AlertDialog.Builder(ReadVerticalSetup.this)
			...
			.setPositiveButton("はい", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					if(col_offset==0&&bg_Offset==0)
					{
						...
						Intent intent=new Intent(ReadVerticalSetup.this, CurlActivityVertical.class);
